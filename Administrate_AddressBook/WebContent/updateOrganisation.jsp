...
<html>
<head>
<title>Organisastion Management System</title>
...
<body>	
	<br/><br/>
	<form action="updateOrg.htm" name="regform" method="get" onsubmit="return validateForm()">
					...
					<table align="center" border="0">
					   ...
					   <tr>	
						   <td colspan="2" align="right">										
						   	 <input value="Update Organisation" type="submit"></td>
						</tr>
						<tr>						
						</tr>
					</tbody></table>
